...
```
Jugue a piedra papel o tijera con Rafa en sets de 20 hasta hacer 200 partidas 
y con Ruben 15 partidas
...
- [X] **IA Especifica**: Entrenada para ganar a UNA persona concreta
  - Nombre/identificador del oponente: Rafa Valerio
